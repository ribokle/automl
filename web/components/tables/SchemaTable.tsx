...
function roleFor(name: string, type: string): { role: string; tone: string } {
  ...
  if (type.toUpperCase().includes("INT") || type.toUpperCase().includes("DOUBLE") || type.toUpperCase().includes("DECIMAL")) {
